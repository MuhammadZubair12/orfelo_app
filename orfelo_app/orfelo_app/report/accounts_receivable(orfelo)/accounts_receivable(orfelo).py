...
class ReceivablePayableReport(object):
	...
	def get_payment_terms(self, row):
		...
		payment_terms_details = frappe.db.sql(
			...
			select
				...
				ps.due_date, ps.payment_term, ps.payment_amount, ps.description, ps.paid_amount, ps.discounted_amount,ps.cd_ndd1,ps.nddndd
	...
	def get_columns(self):
		...
		if self.filters.based_on_payment_terms:
			...
			self.add_column(label=_("CD-NDD"), fieldname="cd_ndd1", fieldtype="Data")
			self.add_column(label=_("NDD-NDD"), fieldname="nddndd", fieldtype="Data")
